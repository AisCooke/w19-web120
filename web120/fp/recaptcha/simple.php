...
$toName = "Dave's Meat & Produce"; //place your client's name here
$website = "davesmeatandproduce.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
    ...
    <div>	
		<label>
			Phone:<br /><input type="phone" name="Phone" required="optional" placeholder="Phone (optional)" title="Phone Number is optional" tabindex="30" size="44" />
		</label>
	</div>
