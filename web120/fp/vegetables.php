<?php include 'includes/header.php';?>
    <section>
        <div class="col-full col-s-full">
        <h2>Your Daily Servings of Healthy & Delicious Vegetables</h2>
      ...
      <section>
        ...
        <img class="col-half col-s-full" src="images/vegetables8.jpg" alt="Vegetables">
      </section>
